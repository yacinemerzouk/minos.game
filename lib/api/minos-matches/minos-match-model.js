...
MinosMatch = class {
    ...
    logManagerLevelUp({ levelUpData }) {

        this.managerLevelUps = this.managerLevelUps || [];
        this.managerLevelUps.push(levelUpData);

    }

    logPlayerLevelUp({ levelUpData }) {

        this.playerLevelUps = this.playerLevelUps || [];
        this.playerLevelUps.push(levelUpData);

    }

    logWinnings({ winningsData }) {

        this.winnings = this.winnings || [];
        this.winnings.push(winningsData);
