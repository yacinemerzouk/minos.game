Package.describe({
  ...
  version: '1.14.2',
  name: 'meteorhubdotnet:useraccounts-unstyled',
...
Package.on_use(function(api, where) {
  ...
  api.use('meteorhubdotnet:useraccounts-iron-routing@1.14.2', ['client', 'server'], {weak: true});
...
Package.on_test(function(api) {
  api.use([
    'meteorhubdotnet:useraccounts-unstyled',
    'meteorhubdotnet:useraccounts-core',
  ]);
